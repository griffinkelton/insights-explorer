...
| [plans/00-sprints/🔵 drive-file-picker-spec.md](plans/00-sprints/🔵 drive-file-picker-spec.md) | Add a Google Drive file picker to the sidebar — load CSVs/Sheets directly | 7 files changed, 2 new: drive_client.py + sidebar UI. Piggybacks on GA4 OAuth. ~236 tests. | 🔵 Planned |
