...
| [plans/🔵 ga4-insights-sketch.md](plans/🔵%20ga4-insights-sketch.md) | Aspirational design sketch for post-v0.3.0 GA4 insights engine — AI auto-analysis on connect, three-layer measurement model, 25 analyses, privacy constraints | Three-layer model (GA4 → questionnaire evidence → survey), 7 always-computed + 5 demographic-dependent insight categories, 7 critical connections (acquisition → equity), AI prompt contract, pre-implementation decisions, small-cell rule, cross-refs `evidence-connector-design.md` | 🔵 Sketch — deferred to post-v0.3.0 |
...
| [plans/🔵 ga4-insights-sketch.md](plans/🔵%20ga4-insights-sketch.md) | Aspirational design sketch for post-v0.3.0 GA4 insights engine — AI auto-analysis on connect, three-layer measurement model, 25 analyses, privacy constraints | 🔵 Sketch — deferred to post-v0.3.0 | 2026-08-02 |

---

*This index was last updated 2026-08-02 — spec v2.9.0 applied (atomic ingestion all paths, `DriveImportError`, `_NamedBytesIO`, 19 Phase 2 tests, step dependency table, multimodal deferral); `ga4-insights-sketch.md` added (post-v0.3.0 aspirational, 275 lines, three-layer model + 25 analyses); closeout references updated to v2.9.0; Phase 1 closeout rows now include cloudbuild + missing-build/ regression evidence.*
