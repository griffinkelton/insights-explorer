...
| `whisperer-30-reference/LOVABLE-UPDATES-080525.md` | Phases 4–5 (Drive-import UI port), evidence-connector workstream, contract reconciliation (`measurement-contract.ts`) |
