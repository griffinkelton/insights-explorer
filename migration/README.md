...
1. ~~**Security:**~~ **DONE (Gate 1, 2026-08-06)** — credentials rotated/revoked (user-confirmed ~2026-08-03); whisperer-30 tracked `.env` untracked (`2341c9c`, branch `fix/remove-tracked-env`, **merged to `main` as `a4d72e8`**); `.gitignore` rules + `.env.example` added; history-wide scans clean in both repos. Closure record: `policies/env-rotation-checklist.md` (§ Gate 1 closure record).
